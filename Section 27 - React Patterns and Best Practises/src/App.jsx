    ...
    <section>
      ...
      <Accordion className='accordion'>
        <Accordion.Item  className='accordion-item'>
          <Accordion.Title id='new' className="accordion-item-title">We got 20 years of experience</Accordion.Title>
          <Accordion.Content id='new' className="accordion-item-content">
          <article>
        ...
        <Accordion.Item  className='accordion-item'>
          <Accordion.Title id='second' className="accordion-item-title">lorem ipsum</Accordion.Title>
          <Accordion.Content id='second' className="accordion-item-content">
          <article>
